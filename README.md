...
## What is this?
This is an interactive digital diary — not just a page with text on it. It's a hand-crafted, immersive experience built entirely in a single HTML file, designed to feel like you're holding something real: a worn leather notebook that belonged to someone who never meant for you to find it.
Open it. Turn the pages. Read what he left behind.
---

## The concept
Simon Riley doesn't talk about his feelings. He races. He wins. He disappears before the ceremony ends.
But somewhere between the pit lane and the podium, between the telemetry sheets and the pre-race briefings, he wrote things down. Small things. Big things. Things he crossed out and rewrote and crossed out again.
This diary is what he left behind — or what he forgot to burn.

---

## What's inside
The diary opens with a **leather-bound cover** sitting on a dark wooden desk, worn at the corners, with stickers collected over the years — a Ghost skull sticker, a mugshot badge, a license plate that says *MEMORIES*. A leather cord holds it shut. It looks like it has a story. It does.
...
## Design & details
Every element of this project was built with intention:
**The cover** feels like a real object. The leather texture, the aged corners, the cord that wraps around it — it's all CSS, no images. The stickers were chosen deliberately: they say something about who this person is without him ever having to say it out loud.
**The pages** use a handwriting font that makes every word feel personal. The paper is aged, ruled with faint lines, with a red margin line on the left — like a real notebook pulled from a shelf.
...
## Technical details
Built entirely in **vanilla HTML + CSS + JavaScript** — no frameworks, no dependencies, no external files required beyond Google Fonts.
...
- ✓ All images embedded as base64 — nothing breaks if hosted anywhere
...
## Context
This project was created as part of a **Janitor AI character build** for a fictional Formula 1 version of Simon Riley (Ghost, from Call of Duty) racing for Red Bull Racing. The diary exists as an in-universe artifact — something you might find in his garage, or on the passenger seat of his car after a race weekend.
